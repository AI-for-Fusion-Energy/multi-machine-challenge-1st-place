...
In `predictions.py`, line `77`, set `cmod_data_folder` to point to the location of the C-Mod data folder (the `cmod` folder that appears as a result of unzipping `C-Mod data.zip`).
